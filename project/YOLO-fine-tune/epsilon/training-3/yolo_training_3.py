...
# model.train(data=f"/home/sooyong/datasets/yolo-dataset/7:1.5:1.5/epsilon-{size}/textbox{textbox}/data.yaml",
...
for size, textbox in combinations:
    ...
    # 결과를 저장할 디렉토리 설정
    save_dir = f"/home/sooyong/datasets/yolo-dataset/results/epsilon-{size}_textbox{textbox}"
